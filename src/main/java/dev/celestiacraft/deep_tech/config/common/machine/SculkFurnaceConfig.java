...
public class SculkFurnaceConfig extends ConfigModule {
	...
	public SculkFurnaceConfig(ForgeConfigSpec.Builder builder) {
		super(builder, "sculk_furnace", LanguageGenerate.configEnglish("module.sculk_furnace"));
	}

	@Override
	protected void addConfigs() {
		MAX_ENERGY = builder.comment(LanguageGenerate.configEnglish("sculk_furnace.max_energy_stored"))
				.comment("type: int")
				.comment("default: 10000")
				.defineInRange("sculk_furnace_max_energy_stored", 10000, 1, Integer.MAX_VALUE);

		MAX_RECEIVE = builder.comment(LanguageGenerate.configEnglish("sculk_furnace.max_energy_receive"))
				.comment("type: int")
				.comment("default: 100")
