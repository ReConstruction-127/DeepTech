...
public class SculkCollectorConfig extends ConfigModule {
	...
	public SculkCollectorConfig(ForgeConfigSpec.Builder builder) {
		super(builder, "sculk_collector", LanguageGenerate.configEnglish("module.sculk_collector"));
	}

	@Override
	protected void addConfigs() {
		MAX_ENERGY = builder.comment(LanguageGenerate.configEnglish("sculk_collector.max_energy_stored"))
				.comment("type: int")
				.comment("default: 10000")
				.defineInRange("sculk_collector_max_energy_stored", 10000, 1, Integer.MAX_VALUE);

		MAX_RECEIVE = builder.comment(LanguageGenerate.configEnglish("sculk_collector.max_energy_receive"))
				.comment("type: int")
				.comment("default: 500")
				.defineInRange("sculk_collector_max_energy_receive", 500, 1, Integer.MAX_VALUE);

		ENERGY_PER_HARVEST = builder.comment(LanguageGenerate.configEnglish("sculk_collector.energy_per_harvest"))
				.comment("type: int")
				.comment("default: 200")
				.defineInRange("sculk_collector_energy_per_harvest", 200, 1, Integer.MAX_VALUE);

		HARVEST_SPEED = builder.comment(LanguageGenerate.configEnglish("sculk_collector.harvest_speed"))
				.comment("type: int")
				.comment("default: 1")
