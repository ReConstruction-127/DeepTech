...
public class SingleTankFluidTransfer implements IFluidTransfer {
	...
	@Override
	public void setFluidInTank(int index, FluidStack stack) {
	...
	@Override
	public FluidStack drain(int index, FluidStack stack, boolean simulate, boolean isFill) {
	...
	@Override
	public FluidStack drain(long maxDrain, boolean simulate, boolean isFill) {
