...
public class DTFluids {
    ...
    public static final RegistryObject<FluidType> LIQUID_EXPERIENCE_TYPE = FLUID_TYPES.register(
            "liquid_experience",
            () -> new FluidType(FluidType.Properties.create()
                    .descriptionId("fluid.deep_tech.liquid_experience")
                    .canSwim(false)
                    .canDrown(false)
    ...
    public static final RegistryObject<ForgeFlowingFluid> LIQUID_EXPERIENCE = FLUIDS.register(
            "liquid_experience",
            () -> new ForgeFlowingFluid.Source(DTFluids.LIQUID_EXPERIENCE_PROPERTIES)
    );

    public static final RegistryObject<ForgeFlowingFluid> LIQUID_EXPERIENCE_FLOWING = FLUIDS.register(
