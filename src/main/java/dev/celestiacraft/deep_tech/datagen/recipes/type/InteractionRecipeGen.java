...
public class InteractionRecipeGen extends DTRecipeProvider {
	...
	public static void addRecipes(Consumer<FinishedRecipe> consumer) {
		...
		InteractionRecipeBuilder.builder()
				...
				.result(DTMaterials.IRON.getDust(), 0.25)
				.result(DTMaterials.IRON.getPlate(), 0.50)
		...
		InteractionRecipeBuilder.builder()
				...
				.target(Blocks.REINFORCED_DEEPSLATE)
				.result(DTMaterials.COPPER.getNugget(), 8, 0.25)
				.result(DTMaterials.COPPER.getDust(), 0.25)
				.result(DTMaterials.COPPER.getPlate(), 0.50)
				.extraEffect(0.1, Blocks.DEEPSLATE, MaterialItems.SCULK_BONEMEAL.get())
				.consume(true)
				.type(InteractionType.LEFT_CLICK)
		...
		InteractionRecipeBuilder.builder()
				...
				.result(DTMaterials.GOLD.getDust(), 0.25)
				.result(DTMaterials.GOLD.getPlate(), 0.50)
				.extraEffect(0.1, Blocks.DEEPSLATE, MaterialItems.SCULK_BONEMEAL.get())
				.consume(true)
				.type(InteractionType.LEFT_CLICK)
